...
public class RepairOrderServiceImpl implements RepairOrderService {
        ...
        private List<String> saveVerificationAttachmentsToDocker(Long repairOrderId, MultipartFile[] attachments)
                        throws IOException {
                List<String> attachmentBase64 = new ArrayList<>();
                if (attachments == null || attachments.length == 0)
                        return attachmentBase64;

                Path uploadDir = Paths.get(attachmentBasePath, "repair_orders", String.valueOf(repairOrderId));
                ...
                return orders.stream()
                                .map(order -> {
                                        ...
                                        return RepairHistoryResponse.builder()
                                                        ...
                                                        .supervisorApproved(Boolean.TRUE
                                                                        .equals(order.getSupervisorApproved()))
